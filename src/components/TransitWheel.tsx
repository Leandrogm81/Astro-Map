...
export default function TransitWheel({ natalChart, transitChart, onChartReady }: TransitWheelProps) {
  ...
  return (
    <div ref={containerRef} className="relative w-full aspect-square max-w-[960px] mx-auto bg-[#020617] rounded-3xl p-4 shadow-2xl border border-slate-800 overflow-hidden">
